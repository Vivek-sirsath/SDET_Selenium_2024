...
/*
 * IMPORTANT:- In this example getText() method is unable to capture the text in the box.
...
public class DoubleClick {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String field2Text = driver.findElement(By.xpath("//input[@id='field2']")).getText();
